...
from convexhull.utils import is_convex, scatter_plot, point_in_polygon


def exhaustive(points, show=False, save=False, detailed=False):
    """
    ...
    while i <= len(points):
        ...
        for subset in permutations(points, i):
            ...
            if (show or save) and detailed:
                scatter_plot(points, [subset], title="exhaustive search", show=show)
